...
<%--  
	...
	Description: 综合查询-接口数据-负面信息表列表页面
--%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrIntNegInfoList");
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/IntDataManage/PidrIntNeginf/PidrIntNeginfInfo.jsp";
