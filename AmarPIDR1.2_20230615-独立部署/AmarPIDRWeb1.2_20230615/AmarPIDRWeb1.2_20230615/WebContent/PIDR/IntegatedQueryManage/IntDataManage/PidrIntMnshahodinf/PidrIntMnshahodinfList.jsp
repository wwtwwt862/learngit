...
<%--  
	...
	Description: 综合查询-接口数据-主要出资人信息表列表页面
--%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrIntMnshahodInfoList");
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/IntDataManage/PidrIntMnshahodinf/PidrIntMnshahodinfInfo.jsp";
