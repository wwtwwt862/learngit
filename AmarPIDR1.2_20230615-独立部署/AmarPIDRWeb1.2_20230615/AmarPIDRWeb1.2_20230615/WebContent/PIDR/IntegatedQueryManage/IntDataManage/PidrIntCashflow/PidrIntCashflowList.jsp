...
<%--  
    ...
    Description:企业评级信息  接口数据    现金流量表   列表页面
--%>
 <%
    ASObjectModel doTemp = new ASObjectModel("PidrIntCashFlowList");
...
<script type="text/javascript">
    ...
    function viewRecord(){
         var url = "/PIDR/IntegatedQueryManage/IntDataManage/PidrIntCashflow/PidrIntCashflowInfoFrame.jsp";
