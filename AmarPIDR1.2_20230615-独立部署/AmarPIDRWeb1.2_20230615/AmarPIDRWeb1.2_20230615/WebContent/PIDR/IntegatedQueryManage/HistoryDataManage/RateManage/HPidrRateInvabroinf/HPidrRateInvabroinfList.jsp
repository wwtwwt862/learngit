...
<%--  
	...
	Description: 综合查询-历史数据-企业评级信息记录-对外投资段信息表列表页面
--%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrRateInvabroinfList");
	doTemp.setJboClass("jbo.pidr.HPIDR_RATE_INVABROINF");// 设置JBO对象
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/HistoryDataManage/RateManage/HPidrRateInvabroinf/HPidrRateInvabroinfInfo.jsp";
