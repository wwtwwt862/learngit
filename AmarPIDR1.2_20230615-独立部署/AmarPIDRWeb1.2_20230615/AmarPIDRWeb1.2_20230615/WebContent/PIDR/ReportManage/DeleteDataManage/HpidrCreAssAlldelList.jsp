...
<%--
       ...
       Description:整笔删除-信贷资产 列表页面
 --%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrAllDltCreAssList");
...
function add(){
	 var url = "/PIDR/ReportManage/DeleteDataManage/HPidrCreAssAlldelInfo.jsp";
	 var operationType = "Add";
	AsDialog.PopView(url,'operationType='+operationType,'dialogWidth:1000px;dialogHeight:600px',function(){
		reloadSelf();
	});
}
/*~[Describe=查询详情,InputParam=无,OutputParam=无]~*/
function view(){
	 var url = "/PIDR/ReportManage/DeleteDataManage/HPidrCreAssAlldelInfo.jsp";
	 ...
	 var params = 'sessionId=' + sessionId + '&delDueCode=' + delDueCode+'&delContractCode='+delContractCode+'&operationType='+operationType;
