...
<%--
	...
	Description:企业评级信息标识变更列表页面
--%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrRateIdChangeList");
...
function view(){
	...
	var params = 'RightType='+rightType+'&SessionId=' + sessionId + '&OldEntCertType=' + oldEntCertType
