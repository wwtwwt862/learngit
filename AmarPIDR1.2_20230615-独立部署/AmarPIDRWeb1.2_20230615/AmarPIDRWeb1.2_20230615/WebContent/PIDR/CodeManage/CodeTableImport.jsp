...
<body bgcolor="#D3D3D3">
<form name="SelectAttachment" method="post" enctype="multipart/form-data" action="<%=request.getContextPath() %>/PidrImpExcelDataServlet?sheetName=CodeMapTemplate&CompClientID=<%=CurComp.getClientID()%>" >
<table align="center" >
	<tr>
    	...
    	<tr>
    		<td>    
    			...
    			<a href="<%=request.getContextPath() %>/PidrDownloadServlet?fileName=<%=path+ARE.getProperty("PIDRBatchImpFile")+"/CodeMapTemplate_PIDR.xls"%>&CompClientID=<%=CurComp.getClientID()%>"><font color=red><b>[下载央行内评代码映射模板]</b></font></a>
    		</td>
    	</tr>
      	<tr>
      	    <td>
