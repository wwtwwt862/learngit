...
--version 2.1---------------------------------------------------------------------------------
1. Frame/skins底层样例皮肤
	底层维护的皮肤，为研发服务，产品及项目不允许修改，但可以不使用
	
2. AppMain/skins开发扩展皮肤
	产品或项目扩展皮肤，为产品服务
	产品升级要注意底层对皮肤是否有另外要求，若有要求需要进行调整

--version 2.1---------------------------------------------------------------------------------
1. 将定制皮肤包形式转换为配置皮肤形式，即将要使用的单个皮肤包配置到skin.xml文件中去。
2. 空文件补充，若引用了皮肤包内不存在的文件，补充空文件。
