...
<%--  
    ...
    Description:前台日志展示列表页面
--%>
<%
	String date = DateX.format(new Date(), "yyyyMMdd");
	String dataHome = ARE.getProperty("WEB_LOG") + "/" + date;
	String jsonDa = "";
	...
	String sButtons[][] = {
		...
		{"true","","Button","刪除","刪除","deleteLog()","","","","btn_icon_delete",""}
	};
%>
...
<script type="text/javascript">
	...
	function downloadLog(){
		...
		document.download.action="<%=request.getContextPath()%>/PidrDownLoadBatchServlet?fileName="+encodeURI(encodeURI(filePath+"logtemp.zip")) + "&batchFileName="+fileName;
