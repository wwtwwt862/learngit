...
<%--  
	...
	Description: 综合查询-历史数据-企业评级信息记录-注册资本信息表列表页面
--%>
<%	
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/HistoryDataManage/RateManage/HPidrRateRegcap/HPidrRateRegcapInfo.jsp";
