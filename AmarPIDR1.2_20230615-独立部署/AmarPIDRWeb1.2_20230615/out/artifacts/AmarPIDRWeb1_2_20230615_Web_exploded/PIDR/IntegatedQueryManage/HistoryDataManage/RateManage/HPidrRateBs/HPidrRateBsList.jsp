...
<%--  
	...
	Description: 综合查询-历史数据-企业评级信息记录-基础段信息表列表页面
--%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrRateBsList");
	doTemp.setJboClass("jbo.pidr.HPIDR_RATE_BS");// 设置JBO对象
	...
	if(PIDRConstants.ALLMSG_FLAG.equals(flag) || PIDRConstants.MDFC_FLAG.equals(flag)) {
	...
	String sButtons[][] = {
		...
		{!PIDRConstants.ALLMSG_FLAG.equals(flag)&&!PIDRConstants.MDFC_FLAG.equals(flag)&&!PIDRConstants.FEEDBACK_FLAG.equals(flag)? "true":"false","","Button","全信息","全信息","allMsg()","","","","btn_icon_detail",""},
	};
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/HistoryDataManage/RateManage/HPidrRateBs/HPidrRateBsInfo.jsp";
	...
	function allMsg(){
		var url = "/PIDR/IntegatedQueryManage/HistoryDataManage/RateManage/HPidrRateBs/HPidrRateBsAllMsg.jsp";
		var sessionId = getItemValue(0,getRow(0),'SessionId');// 期次号
		var customerId = getItemValue(0,getRow(0),'CustomerId');// 客户编号
		var params = 'SessionId=' + sessionId + '&CustomerId=' + customerId;
