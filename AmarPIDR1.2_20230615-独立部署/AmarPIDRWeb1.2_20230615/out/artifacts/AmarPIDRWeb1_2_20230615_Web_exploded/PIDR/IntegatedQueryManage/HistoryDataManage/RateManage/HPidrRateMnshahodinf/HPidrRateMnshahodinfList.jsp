...
<%--  
	...
	Description: 综合查询-历史数据-企业评级信息记录-主要出资人信息表列表页面
--%>
<%	
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/HistoryDataManage/RateManage/HPidrRateMnshahodinf/HPidrRateMnshahodinfInfo.jsp";
