...
<%--  
	...
	Description: 综合查询-接口表数据-注册资本信息表列表页面
--%>
<%	
	ASObjectModel doTemp = new ASObjectModel("PidrIntBusiInfoList");
...
<script type="text/javascript">
	...
	function view(){
		var url = "/PIDR/IntegatedQueryManage/IntDataManage/PidrIntBusiinf/PidrIntRegcapInfo.jsp";
