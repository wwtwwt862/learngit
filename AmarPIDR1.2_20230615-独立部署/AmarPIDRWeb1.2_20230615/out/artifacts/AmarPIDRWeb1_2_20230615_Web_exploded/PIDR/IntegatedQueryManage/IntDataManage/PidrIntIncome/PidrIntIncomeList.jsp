...
<%@ include file="/Frame/resources/include/include_begin_list.jspf"%>
 ...
 <%--  
    ...
    Description:企业评级信息  接口表数据    利润表   列表页面
--%>
 <%
    ASObjectModel doTemp = new ASObjectModel("PidrIntIncomeList");
...
<script type="text/javascript">
    ...
    function viewRecord(){
         var url = "/PIDR/IntegatedQueryManage/IntDataManage/PidrIntIncome/PidrIntIncomeInfoFrame.jsp";
