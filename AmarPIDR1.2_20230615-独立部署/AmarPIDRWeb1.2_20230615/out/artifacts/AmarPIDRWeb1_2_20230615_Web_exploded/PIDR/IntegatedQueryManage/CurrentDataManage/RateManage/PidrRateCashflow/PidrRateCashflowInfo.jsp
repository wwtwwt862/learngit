...
<%--  
    ...
    Description:企业评级信息  当期数据    现金流量表   本期详情页面
--%>
<%
...
%>
<%
    ASObjectModel doTemp = new ASObjectModel("PidrRateCashflowInfo");
...
<script type="text/javascript">
    ...
    /*~[Describe=保存后的操作,InputParam=无,OutputParam=无]~*/
    function check(){
    	//保存之后的处理
